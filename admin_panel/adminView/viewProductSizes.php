...
<div >
  ...
  <table class="table ">
    ...
    <?php
      ...
      $sql="SELECT * from product_size_variation v, product p, product_status s WHERE p.product_id=v.product_id AND v.status_id=s.status_id ";
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">New Product Variation</h4>
